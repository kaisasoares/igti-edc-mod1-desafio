...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
        Name='EMR-Kaisa-IGTI-rais',
        ServiceRole='EMR_DefaultRole',
        JobFlowRole='EMR_EC2_DefaultRole',
        VisibleToAllUsers=True,
        LogUri='s3://datalake-igti-edc-kass-tf/emr-logs',
        ...
        Instances={
            ...
            'Ec2SubnetId': 'subnet-0c205d26c24ba18a4'
        },
            ...
            'Name': 'Transformacao para parquet',
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': [
                            ...
                            '--master', 'yarn',
                            '--deploy-mode', 'cluster',
                            's3://datalake-igti-edc-kass-tf/emr-code/pyspark/emr_job_spark.py'
                        ]
                    }
        }],
    )
